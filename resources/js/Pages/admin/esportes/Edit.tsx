...
export default function EsportesEdit({ esporte, categorias }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        name: esporte.name,
        type: esporte.type,
        categorias: esporte.categorias.map((c) => c.id),
    });

    function handleSubmit(e: React.FormEvent) {
        e.preventDefault();
        put(`/admin/esportes/${esporte.id}`);
    }
    ...
    return (
        <AdminLayout title="Editar Esporte">
            <Head title="Editar Esporte" />
